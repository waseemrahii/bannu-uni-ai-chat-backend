...
//   //     // Execute search
//   //     let results = await VectorDocument.aggregate(pipeline).limit(topK)

//   //     if (!results || results.length === 0) {
//   //       console.log("[RAGService] Vector search returned no results, falling back to keyword search")
//   //       results = await this.keywordSearch(query, filters, topK)
//   //     }

//   //     console.log(`[RAGService] Retrieved ${results.length} documents`)
...
//   //     try {
//   //       console.log("[RAGService] Vector search failed, attempting keyword search fallback")
//   //       const results = await this.keywordSearch(query, filters, topK)
//   //       return results
//   //     } catch (fallbackError) {
//   //       console.error("[RAGService] Keyword search fallback also failed:", fallbackError.message)
//   //       return []
//   //     }
//   //   }
//   // }
...
//     // FIXED: Use $vectorSearch instead of $search with knnBeta
//     const pipeline = [
//       {
//         $vectorSearch: {
//           index: "vector_search_index", // Your index name
//           path: "embedding",
