...
import { queueResultIngestion } from "../services/backgroundIngestionService.js"
...
export const createResult = asyncHandler(async (req, res) => {
  ...
  const duplicateSubjects = await Result.checkDuplicateSubjects(data.rollNo, data.semester, subjects)
  ...
  queueResultIngestion(doc._id, "create")
  console.log(`[ResultController] Queued ingestion for result: ${doc._id}`)
...
export const updateResult = asyncHandler(async (req, res) => {
  ...
  if (req.body.items) {
    ...
    const duplicateSubjects = await Result.checkDuplicateSubjects(result.rollNo, result.semester, subjects)
  ...
  queueResultIngestion(req.params.id, "update")
  console.log(`[ResultController] Queued ingestion for updated result: ${req.params.id}`)
...
export const deleteResult = asyncHandler(async (req, res) => {
  ...
  queueResultIngestion(req.params.id, "delete")
  console.log(`[ResultController] Queued deletion from vector DB for result: ${req.params.id}`)
