...
import { queueEventIngestion } from "../services/backgroundIngestionService.js"
...
export const createEvent = asyncHandler(async (req, res) => {
  ...
  queueEventIngestion(doc._id, "create")
  console.log(`[EventController] Queued ingestion for event: ${doc._id}`)
...
export const listEvents = asyncHandler(async (req, res) => {
  const { search, semester, department, page = 1, limit = 10, sort = "date", order = "asc" } = req.query
...
export const updateEvent = asyncHandler(async (req, res) => {
  ...
  queueEventIngestion(id, "update")
  console.log(`[EventController] Queued ingestion for updated event: ${id}`)
...
export const deleteEvent = asyncHandler(async (req, res) => {
  ...
  queueEventIngestion(id, "delete")
  console.log(`[EventController] Queued deletion from vector DB for event: ${id}`)
