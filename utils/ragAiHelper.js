...
import ragService from "../services/ragService.js"
import RAGContextBuilder from "./ragContextBuilder.js"
import DateFilterHelper from "./dateFilterHelper.js"
import User from "../models/userModel.js"
...
export const processStudentMessageWithRAG = async (userId, message) => {
  try {
    ...
    const dateFilter = DateFilterHelper.extractDateFilter(message)
    Object.assign(filters, dateFilter)

    console.log("[RAG AI Helper] Applied filters:", filters)
