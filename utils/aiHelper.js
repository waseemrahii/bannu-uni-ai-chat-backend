...
//     // if (intent === "UNKNOWN" && /(class|lecture|lab|schedule)/i.test(message)) {
//     //   setPending(userId, { type: "CLASS", originalMessage: message })
//     //   return {
//     //     reply: "Do you want class timings for today, tomorrow, yesterday, or a specific day?",
...
//       case "RESULT":
//         return await handleResultQuery(user)
        
//      // In the switch statement, update the EVENT case:
// case "EVENT":
//   try {
...
// Provide a brief, helpful response related to classes, exams, events, or university information.`
//         )
//         return {
//           reply: aiResponse || "I'm not sure about that. Could you ask about classes, exams, events, or university status?",
//           intent: "UNKNOWN"
//         }
//     }
//   } catch (error) {
...
import { handleExamScheduleQuery } from "../handlers/examScheduleHandler.js"
import { handleQuizQuery } from "../handlers/quizHandler.js"
import { handleAssignmentQuery } from "../handlers/assignmentHandler.js" // ADD THIS
import { handleResultQuery } from "../handlers/resultHandler.js"
import { handleEventQuery } from "../handlers/eventHandler.js"
import { handleGeneralInfoQuery } from "../handlers/generalInfoHandler.js"
import { handleUniversityStatusQuery } from "../handlers/universityStatusHandler.js"
