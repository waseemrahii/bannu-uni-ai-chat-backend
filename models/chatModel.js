...
const chatSchema = new mongoose.Schema(
  {
    userId: { type: mongoose.Schema.Types.ObjectId, ref: "User", required: true },
    conversationId: { type: String, default: () => new Date().getTime().toString() },
    conversationTitle: { type: String, default: null },
    isFirstMessage: { type: Boolean, default: false },
    parentMessageId: { type: mongoose.Schema.Types.ObjectId, ref: "Chat" },
    question: String,
    answer: String,
    intent: String,
    status: {
